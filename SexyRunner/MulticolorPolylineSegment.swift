...
class MulticolorPolylineSegment: MKPolyline {
    ...
    private class func allSpeeds(forLocations locations: [Location]) ->
        (speed: [Double], minSpeed: Double, maxSpeed: Double) {
        // Make Array of all speeds. Find slowest and fastest
            ...
            for i in 1..<locations.count {
                ...
                let cl1 = CLLocation(latitude: l1.latitude.doubleValue, longitude: l1.longtitude.doubleValue)
                let cl2 = CLLocation(latitude: l2.latitude.doubleValue, longitude: l2.longtitude.doubleValue)
    ...
    class func colorSegments(forLocations locations: [Location]) -> [MulticolorPolylineSegment] {
        ...
        for i in 1..<locations.count {
            ...
            coords.append(CLLocationCoordinate2D(latitude: l1.latitude.doubleValue, longitude: l1.longtitude.doubleValue))
            coords.append(CLLocationCoordinate2D(latitude: l2.latitude.doubleValue, longitude: l2.longtitude.doubleValue))
